import { getAuth, signInWithEmailAndPassword, signOut, onAuthStateChanged, createUserWithEmailAndPassword, } from 'https://www.gstatic.com/firebasejs/9.9.4/firebase-auth.js';
...
export function addEventListeners() {
    ...
    Elements.fromSignIn.addEventListener('submit', async e => {
        e.preventDefault();
        ...
        try {
            ...
            if (Constants.DEV)
                console.log('sign in error:' + JSON.stringify(errorCode) + JSON.stringify(errorMessage));
        }
    });
